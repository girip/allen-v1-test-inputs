...
base_stimulus_save_path = './my_stimulus/2ms_stimulus_presentation_time'
...
for frequency in frequencies:
    for stimulus_presentation_time_ms in stimulus_presentation_times:
        for pixel_in in pixel_intensities:

            duty = frequency * stimulus_presentation_time_ms / 1000
            ...
            print("frequency: {} duty cycle: {} pixel intensity: {}".format(frequency, duty, pixel_in))
